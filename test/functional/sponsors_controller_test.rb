...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { description: @sponsor.description, name: @sponsor.name, picture_url: @sponsor.picture_url, url: @sponsor.url }
    end
  ...
  test "should update sponsor" do
    put :update, id: @sponsor, sponsor: { description: @sponsor.description, name: @sponsor.name, picture_url: @sponsor.picture_url, url: @sponsor.url }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
